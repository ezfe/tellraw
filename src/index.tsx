...
import { faEdit, faPlusCircle, faKeyboard, faTrophy, faUserTag, faTrashAlt } from '@fortawesome/free-solid-svg-icons';
library.add(faEdit, faPlusCircle, faKeyboard, faTrophy, faUserTag, faTrashAlt)
