...
import {
	...
	LSKEY_BOOK_PREVIEW_DISCLAIMER,
	LSKEY_COMMAND_STRING,
	LSKEY_COMMAND_TYPE,
	LSKEY_CUSTOM_COLORS,
	LSKEY_CUSTOM_LANGUAGE_TRANSLATIONS,
	LSKEY_LIT_SIGN,
	LSKEY_PREVIEW_BGC,
...
export const customLanguageTranslations = buildStore(
	INITIAL_CUSTOM_TRANSLATIONS,
	LSKEY_CUSTOM_LANGUAGE_TRANSLATIONS
);
